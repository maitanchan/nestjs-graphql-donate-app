...
import { Box, Text, Button, Heading, NumberInput, NumberInputField, SimpleGrid, VStack, useRadioGroup } from '@chakra-ui/react'
...
export const CountSelection = ({ initialCount, next }: Props) => {
    ...
    return (
        ...
        <VStack spacing={4} align='stretch'>
            ...
            <Button w='100%' colorScheme='orange' size='lg' borderRadius='full' onClick={nextSteps}>
                Next
            </Button>
